return {
    ...
    },
    {
        ...
        favored_size_multiplier_enabled = true,
			rating_specific_weights = {
				...
				["HOSTILE"] = { [1]=0, [2]=0, [3]=5, [4]=0, [5]=10, [6]=10, [7]=40, [8]=20, [9]=10 }, 
    ...
    },
    {
        ...
        favored_size_multiplier_enabled = true,
        tok = {[[
		[CREATURE_TILE:'C'][CREATURE_CLASS:SIZE_HUGE]
    ...
    },
    {
        ...
        tok = {[[
		[CREATURE_TILE:'C'][CREATURE_CLASS:SIZE_TITANIC]
    ...
    procgen_table_sub_archetype = {
    {
        ...
        desc_part = "A mechanical construct This variant is a feral machine long-deviated from the designs of pan-humanity, with the form of an irregular mass of machinery, tubing, and wires. ",
    ...
    },
    {
        ...
        desc_part = "An artificially engineered life form made form synthetic tissues strengthened by internal nanites and alloy particulates, granting it functionality on par with any true machine. This variant descends from the cybermechs created during the Transitional Era, hulking drudges and slave soldiers cast out into the dark to labor and slaughter without oversight or maintenance, many growing feral in their long isolation. It has thick, craggy skin with tubing half-embedded in its flesh. ",
    ...
    procgen_subchart_table_devil_body = {
		...
		next_tables = {
		"procgen_subchart_table_dermal",
		"procgen_subchart_table_industrial_head",
		"procgen_subchart_table_industrial_arms",
		"procgen_subchart_table_industrial_legs",
		"procgen_subchart_table_industrial_other"
		}
            },
            {     
                body_token = "", 
	...
	-- =================================================================================================================================================================================================
        ...
        procgen_subchart_table_dermal = {
            {     
                body_token = "", 
                desc_part = "a meta-alloy chassis. ",
			eligible_rating_tags = {"SOPHONT", "DEVIANT", "VESSEL", "DANGEROUS", "HAZARDOUS", "NOMAD", "VEHICLE", "CARRIER", "WEAPON", "MILITARY", "SERVANT", "BENIGN", "PROBLEMATIC", "DOMESTIC", "HUNTER", "LABOR", "SANITATION", "PRODUCT", "VERMIN", "AMBIENT"},
                eligible_size_tags = {"LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT", "TITANIC"}, 
                tok = {[[
	...
	[BP_APPEARANCE_MODIFIER:DENSE:0:70:90:100:110:130:200]
		[APP_MOD_IMPORTANCE:10000]
            ...
            {     
                body_token = "", 
                desc_part = "a self-repairing B-tech chassis. ",
