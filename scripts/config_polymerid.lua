...
return {
    ...
    COMPONENT_TABLES = {
        ...
        -- By adding the below flag, this component is ignored for uniqueness checks.
	   ...
	   procgen_addon_table_4 = {
    
		{
            ...
            },
			{
				...
				tok = {[[ 
				[CLUSTER_NUMBER:1:5][LOOSE_CLUSTERS]
				]]}, 
                weight = 25
			},
			{
                body_token = "",
                desc_part = "It travels in swarms for protection from predators. ",
				eligible_rating_tags = {"BENIGN", "PROBLEMATIC", "HAZARDOUS"},
				eligible_size_tags = { "LESSER", "MEDIUM"}, 
				tok = {[[ 
				[CLUSTER_NUMBER:10:30][LOOSE_CLUSTERS]
				]]}, 
                weight = 10
        }
    },
