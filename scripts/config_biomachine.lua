return {
    ...
    procgen_table_sub_archetype = {
    {
        ...
        desc_part = "_______________________________________________________ _____/TYPE = An artificially engineered life form made from synthetic tissues strengthened by internal nanites and alloy particulates, granting it functionality on par with any true machine. This variant descends from the first users of N-matter which revolted against the Geno-Autarchs, most falling into mindless predation in the process. It has a sinewy build with leathery skin wrapped tight against its body, seams on its skin split open to interface with invasive machinery. _______________________________________________________ _____/DESC = ",
    ...
    {
        body_token = "TORSO_MODULAR:CORE:SPINE:RIBCAGE",
        desc_part = "_______________________________________________________ _____/TYPE = An artificially engineered life form made form synthetic tissues strengthened by internal nanites and alloy particulates, granting it functionality on par with any true machine. This variant is a modern transhuman configuration, built in the image of pan-human physique even if its genetic code is something else entirely. Seams on its skin split open to interface with invasive machinery. _______________________________________________________ _____/DESC = ",
    ...
    {
        body_token = "TORSO_MODULAR:CORE:SPINE:RIBCAGE",
        desc_part = "_______________________________________________________ _____/TYPE = An artificially engineered life form made form synthetic tissues strengthened by internal nanites and alloy particulates, granting it functionality on par with any true machine. This variant descends from the biomechs created during the Transitional Era, hulking drudges and slave soldiers cast out into the dark to labor and slaughter without oversight or maintenance, many growing feral in their long isolation. It has thick, craggy skin with tubing half-embedded in its flesh. _______________________________________________________ _____/DESC = ",
    ...
    {
        body_token = "TORSO_MODULAR:CORE:SPINE:RIBCAGE",
        desc_part = "_______________________________________________________ _____/TYPE = An artificially engineered life form made form synthetic tissues strengthened by internal nanites and alloy particulates, granting it functionality on par with any true machine. This variant descends from those degenerated beyond saving, or created so by the mad hyperintelligences of the deep Datasphere. It is abnormally, horrendously deformed, riddled with cancers, misshapen and twisted. _______________________________________________________ _____/DESC = ",
