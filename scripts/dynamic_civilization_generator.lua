    ...
    LOCASTE = {
        ...
        subs = {
            STANDARD = {
                ...
                sizes = {
                    MDM = { "arrivaltypes", "languages_human", "bandits_medium", "law_serious_order", "law_petty_order", "trophys", "torture_law", "slaves", "citysites", "higher_positions_human", "shield_low", "allguns" }
                }
            }
        }
    },
    NUCASTE = {
        ...
        subs = {
            STANDARD = {
                ...
                allowed_ratings = { "SPNT" },
                sizes = {
                    MDM = { "arrivaltypes", "languages_transitional", "bandits_medium", "law_serious_order", "law_petty_order", "trophys", "torture_law", "slaves", "allsites", "higher_positions_human", "shield_low", "allguns" },
                    LRG = { "arrivaltypes", "languages_transitional", "bandits_medium", "law_serious_order", "law_petty_order", "trophys", "torture_law", "slaves", "allsites", "higher_positions_human", "shield_low", "allguns" }
                }
            }
        }
    },
    HICASTE = {
        ...
        subs = {
            STANDARD = {
                ...
                allowed_ratings = { "SPNT" },
                sizes = {
                    MDM = { "arrivaltypes", "languages_imperial", "bandits_low", "law_serious_order", "law_petty_order", "trophys", "torture_law", "slaves", "arcologysites", "higher_positions_elite", "shield_high", "techguns" },
                    LRG = { "arrivaltypes", "languages_imperial", "bandits_low", "law_serious_order", "law_petty_order", "trophys", "torture_law", "slaves", "arcologysites", "higher_positions_elite", "shield_high", "techguns" }
                }
            }
        }
    },
    EXCASTE = {
        subs = {
            APE = {
                ...
                sizes = {
                    MDM = { "arrivaltypes", "languages_tribal", "bandits_high", "law_serious_chaos", "law_petty_chaos", "trophys", "torture_chaos", "slaves", "tribesites", "higher_positions_tribal", "allguns" }
                }
            },
            CLONE = {
                weight = 5,
            ...
            BLINDSIGHT = {
                ...
                allowed_ratings = { "DVNT" }, 
                sizes = {
                    MDM = { "arrivaltypes", "languages_tribal", "bandits_high", "law_serious_chaos", "law_petty_chaos", "trophys", "torture_chaos", "slaves", "outersites", "lower_positions_tribal", "allguns" }
                }
            }
        }
    },
    ...
    CYCASTE = {
        ...
        subs = {
            STANDARD = {
                ...
                allowed_ratings = { "SPNT" },
                sizes = {
                    MDM = { "arrivaltypes", "languages_transitional", "bandits_medium", "law_serious_order", "law_petty_order", "trophys", "torture_law", "slaves", "spacersites", "higher_positions_human", "shield_all", "allguns" }
                }
            }
        }
    },
    ...
    BIOMACHINE = { 
        subs = {
            DEVIL = {
                ...
                allowed_ratings = { "DVNT" }, 
                sizes = {
                    MDM = { "arrivaltypes", "languages_posthuman", "bandits_high", "law_serious_chaos", "law_petty_chaos", "trophys", "torture_chaos", "slaves", "outersites", "higher_positions_bioroid", "allguns" },
                    LRG = { "arrivaltypes", "languages_posthuman", "bandits_high", "law_serious_chaos", "law_petty_chaos", "trophys", "torture_chaos", "slaves", "cavesites", "higher_positions_bioroid", "allguns" }
                }
            },
            HUMAN = {
                weight = 5,
                allowed_ratings = { "SPNT" }, 
                sizes = {
                    MDM = { "arrivaltypes", "languages_transitional", "bandits_low", "law_serious_order", "law_petty_order", "trophys", "torture_law", "slaves", "monosites", "higher_positions_human", "allguns" }
                }
            },
            OGRE = {
                weight = 5,
                ...
                sizes = {
                    MDM = { "arrivaltypes", "languages_tribal", "bandits_high", "law_serious_chaos", "law_petty_chaos", "trophys", "torture_chaos", "slaves", "outersites", "lower_positions_tribal", "allguns" },
                    LRG = { "arrivaltypes", "languages_tribal", "bandits_high", "law_serious_chaos", "law_petty_chaos", "trophys", "torture_chaos", "slaves", "cavesites", "lower_positions_tribal", "allguns" }
                }
            }
        }
    },
    ...
    NANOMACHINE = { 
        subs = {
            CORRUPT = {
                ...
                allowed_ratings = { "DVNT", "SPNT" }, 
                sizes = {
                    MDM = { "arrivaltypes", "languages_posthuman", "bandits_high", "law_serious_chaos", "law_petty_chaos", "trophys", "torture_chaos", "slaves", "outersites", "higher_positions_nanoroid", "allguns" },
                    LRG = { "arrivaltypes", "languages_posthuman", "bandits_high", "law_serious_chaos", "law_petty_chaos", "trophys", "torture_chaos", "slaves", "cavesites", "higher_positions_nanoroid", "allguns" }
                }
            },
            PRISTINE = {
                weight = 5,
                ...
                sizes = {
                    MDM = { "arrivaltypes", "languages_transitional", "bandits_low", "law_serious_order", "law_petty_order", "trophys", "torture_law", "slaves", "monosites", "higher_positions_human", "allguns" },
                    LRG = { "arrivaltypes", "languages_transitional", "bandits_low", "law_serious_order", "law_petty_order", "trophys", "torture_law", "slaves", "monosites", "higher_positions_human", "allguns"}
                }
            },
            WET = {
                weight = 5,
    ...
    CYBERMACHINE = {
        ...
        subs = {
            STANDARD = {
                ...
                sizes = {
                    MDM = { "arrivaltypes", "languages_transitional", "bandits_medium", "law_serious_order", "law_petty_order", "trophys", "torture_law", "slaves", "spacersites", "higher_positions_cyberoid", "shield_all", "allguns" }
                }
            }
        }
    },
    NECROMACHINE = {
        ...
        subs = {
            STANDARD = {
                ...
                allowed_ratings = { "DVNT" },
                sizes = {
                    MDM = { "arrivaltypes", "languages_transitional", "bandits_medium", "law_serious_order", "law_petty_order", "trophys", "torture_law", "slaves", "outersites", "higher_positions_necroid", "shield_low", "gunpowder" }
                }
            }
        }
    }
