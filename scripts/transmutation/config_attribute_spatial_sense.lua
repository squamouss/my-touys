...
return {
    ...
    ABILITY_ADV_NAME = "Attribute Program- Spatial Sense",
    ...
    PAYLOAD_EFFECTS = {
        PRIMARY = {
            string.format("[CE_MENT_ATT_CHANGE:SPATIAL_SENSE:500:0:START:0:END:%d]", 10000)
        },
        SECONDARY = {
            string.format("[CE_MENT_ATT_CHANGE:SPATIAL_SENSE:400:0:START:0:END:%d]", 10000)
        },
        TERTIARY = {
            string.format("[CE_MENT_ATT_CHANGE:SPATIAL_SENSE:300:0:START:0:END:%d]", 10000)
        },
        QUATERNARY = {
            string.format("[CE_MENT_ATT_CHANGE:SPATIAL_SENSE:200:0:START:0:END:%d]", 10000)
        }
    },
