...
return {
    ...
    FORT_CATEGORY_ID = "COMBAT_PROGRAM_CANNON",
    FORT_CATEGORY_NAME = "Combat Programs- Cannon",
    FORT_CATEGORY_DESC = "Install an cannonmatic weapon",
    
    -- Adventure Mode crafting
    ADV_CATEGORY_ID = "COMBAT_PROGRAM_CANNON_ADV",
    ADV_CATEGORY_NAME = "Combat Program- Cannon",
