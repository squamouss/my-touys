...
return {
    ...
    ABILITY_ADV_NAME = "Attribute Program- Endurance",
    ...
    PAYLOAD_EFFECTS = {
        PRIMARY = {
            string.format("[CE_PHYS_ATT_CHANGE:ENDURANCE:500:0:START:0:END:%d]", 10000)
        },
        SECONDARY = {
            string.format("[CE_PHYS_ATT_CHANGE:ENDURANCE:400:0:START:0:END:%d]", 10000)
        },
        TERTIARY = {
            string.format("[CE_PHYS_ATT_CHANGE:ENDURANCE:300:0:START:0:END:%d]", 10000)
        },
        QUATERNARY = {
            string.format("[CE_PHYS_ATT_CHANGE:ENDURANCE:200:0:START:0:END:%d]", 10000)
        }
    },
