...
return {
    ...
    FORT_CATEGORY_ID = "COMBAT_PROGRAM_NANOJET",
    FORT_CATEGORY_NAME = "Combat Programs- Nanomachine Jet",
    FORT_CATEGORY_DESC = "Install an automatic weapon",
    
    -- Adventure Mode crafting
    ADV_CATEGORY_ID = "COMBAT_PROGRAM_NANOJET_ADV",
    ADV_CATEGORY_NAME = "Combat Program- Nanomachine Jet",
