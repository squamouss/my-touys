...
return {
    ...
    generic_creature_lore_snippets = {
        "_______________________________________________________ _____/HISTORY = Excaste are human-derived peoples and fauna descended from those victimized by the hypertechnological afflictions of the solar system's final golden age. Rogue cloning systems, desperate bioengineering experiments, retroviral plagues, and worse. Often completely removed from the culture and legacy of caste-born sophonts, they know know as much of the present as the earliest humans did of their own world, save those welcomed back into the fold by pan-humanity. The rest are consigned to short lives of desperation, ignorance, and terror. _______________________________________________________ _____",
    },
   ...
   interaction_rating = {
    ...
    procgen_table_sub_archetype = {
    {
        ...
        desc_part = "_______________________________________________________ _____/TYPE = A once-human subjected to so sufficient degredation it can no longer be identified as sophont, existing completely outside of the genetic caste system. The product of retroviral engineering to escape the proprietary DNA of the Geno-Autarchs, it has toughened, leathery skin and animalistic features. _______________________________________________________ _____/DESC = ",
    ...
    {
        body_token = "HUMANOID_NECK:2LUNGS:HEART:GUTS:ORGANS:HUMANOID_JOINTS:THROAT:NECK:SPINE:BRAIN:SKULL:RIBCAGE",
        desc_part = "_______________________________________________________ _____/TYPE = A once-human subjected to so sufficient degredation it can no longer be identified as sophont, existing completely outside of the genetic caste system. The product of cloning systems co-opted by the megastructures long ago, it has a neotenic appearance with a rounded head and hairless skin that seems perpetually slick with fluids. _______________________________________________________ _____/DESC = ",
    ...
    {
        body_token = "HUMANOID_NECK:2LUNGS:HEART:GUTS:ORGANS:HUMANOID_JOINTS:THROAT:NECK:SPINE:BRAIN:SKULL:RIBCAGE",
        desc_part = "_______________________________________________________ _____/TYPE = A once-human subjected to so sufficient degredation it can no longer be identified as sophont, existing completely outside of the genetic caste system. The product of retroviral genetic weapons and toxic contamination, its body is knobbed and distended with cancerous mass, addled by its rebellious flesh. _______________________________________________________ _____/DESC = ",
    ...
    },
    {
        ...
        desc_part = "_______________________________________________________ _____/TYPE = A once-human subjected to so sufficient degredation it can no longer be identified as sophont, existing completely outside of the genetic caste system. Inhabited by the refuse of the digital ecosystem, its weathered skin and clumsy gait, coupled with many surgical scars, mark it as a refuge for lowly Datasphere entities or even mere self-perpetuating algorithms. An electronic brain hums within, clasped to what remains of the brainstem to puppet its host. _______________________________________________________ _____/DESC = ",
