...
return {
   ...
   interaction_rating = {
    ...
    procgen_table_sub_archetype = {
    {
        ...
        desc_part = "A once-human subjected to so sufficient degredation it can no longer be identified as sophont, existing completely outside of the genetic caste system. The product of retroviral engineering to escape the proprietary DNA of the Geno-Autarchs, it has toughened, leathery skin and animalistic features. ",
