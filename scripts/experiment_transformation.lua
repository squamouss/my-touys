...
local TRANSFORMATION_PREFIX_POOLS = {
	BIOMACHINE = { "LOCASTE", "UNCASTE", "EXCASTE", "HICASTE", "CYCASTE" },
}
...
[INTERACTION:__INTERACTION_ID__]
    [I_TARGET:A:CORPSE]
        ...
        [IT_AFFECTED_CLASS:UNCASTE_MALE]
        [IT_AFFECTED_CLASS:UNCASTE_FEMALE]
    ...
    [SYNDROME]
        ...
        [SYN_AFFECTED_CLASS:UNCASTE_FEMALE]
    ...
    [SYNDROME]
        ...
        [SYN_AFFECTED_CLASS:UNCASTE_MALE]
