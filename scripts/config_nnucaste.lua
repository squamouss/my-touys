...
return {
   ...
   interaction_rating = {
    ...
    procgen_table_sub_archetype = {
    {
        ...
        desc_part = "A human with a sickly appearance and prominent cybernetic augmentations fused to its body, the product of hereditary cyberization with minimal use of N-matter. ",
	...
	-- 
		...
		"procgen_subchart_table_cyborg_legs"
            ...
            {     
                body_token = "", 
                desc_part = "It has a perpetually emaciated, sallow-skinned body, any fat it possesses bunched up into hanging lobes, with ",
				eligible_rating_tags = {"SOPHONT", "HOSTILE"},
		...
		"procgen_subchart_table_cyborg_legs"
            ...
            {     
                body_token = "", 
                desc_part = "It has a body in a perpetual state of near-decay, afflicted by sores and necrotic tissues, any fat it possesses bunched up into hanging lobes, with ",
				eligible_rating_tags = {"SOPHONT", "HOSTILE"},
				eligible_size_tags = {"LARGE", "HUGE"}, 
                tok = {[[
