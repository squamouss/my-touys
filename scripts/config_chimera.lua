...
return {
    ...
    COMPONENT_TABLES = {
        ...
        { name = "component_5", table_key = "procgen_addon_table_5", use_for_fingerprint = false }
    },
	...
	[BODY_DETAIL_PLAN:BODY_HAIR_TISSUE_LAYERS:HAIR]
	   ...
	   procgen_addon_table_4 = {
    
		{
			...
			{
                body_token = "",
                desc_part = "It travels by itself, only meeting others of its kind to mate. ",
			...
			{
                body_token = "",
                desc_part = "It travels in pairs or by itself. ",
				eligible_rating_tags = {"BENIGN", "PROBLEMATIC", "HAZARDOUS", "DANGEROUS"},
				eligible_size_tags = {"LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT"}, 
				tok = {[[ 
				[CLUSTER_NUMBER:1:2]
			...
			{
                body_token = "",
                desc_part = "It travels in small groups or rarely by itself. ",
				eligible_rating_tags = {"BENIGN", "PROBLEMATIC", "HAZARDOUS", "DANGEROUS"},
			...
			{
                body_token = "",
                desc_part = "It travels in herds or small groups. ",
				eligible_rating_tags = {"BENIGN", "HAZARDOUS"},
				eligible_size_tags = {"LESSER", "MEDIUM", "LARGE", "HUGE"}, 
				tok = {[[ 
				[CLUSTER_NUMBER:3:12]
			...
			{
                body_token = "",
                desc_part = "It travels in a close-knit pack. ",
			...
			{
                body_token = "",
                desc_part = "It travels in loose groups of individuals, not a true herd or pack but staying together for protection. ",
