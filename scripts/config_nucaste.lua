...
return {
    ...
    generic_creature_lore_snippets = {
        "_______________________________________________________ _____/HISTORY = The Nucaste are the descendants of those who broke away from the caste system of the geno-autarchs following their collapse, turning to radical bioengineering and hereditary cybernetics to carve new niches for their people and empower themselves. This was rarely without cost, the delayed self-destruct mechanisms woven into their genome triggering at the slightest attempt at tampering, but those who survived such efforts would go on to become the new masters of the Transitional Era. _______________________________________________________ _____",
    },
   ...
   interaction_rating = {
    ...
    generic_body_size_variants = {
        ...
        [CREATURE_TILE:'u']
        [CREATURE_SOLDIER_TILE:128]CREATURE_CLASS:SIZE_MEDIUM]
    ...
    procgen_table_sub_archetype = {
    {
        ...
        desc_part = "_______________________________________________________ _____/TYPE = A human of the Transitional Era, the product of hereditary cyberization through N-matter in defiance of the genetic caste system. It is a mix of minimalistic augmentations and sickly flesh, often suffering from genetic diseases and a weakened immune system. This variant was the common citizen of the factory-arcologies during the Transitional Era, crowding out the high and low castes of prior millennia only to be brought down in turn when the Myriad god-entities destroyed their civilizations. _______________________________________________________ _____/DESC = ",
