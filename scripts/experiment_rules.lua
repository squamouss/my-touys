        ...
        cases = {
            {
                ...
                allowed_targets = {"LOCASTE", "HICASTE", "NUCASTE", "EXCASTE", "BIOMACHINE" },
                outcomes = {
                    {
                ...
                outcomes = {
                    {
                        ...
                        forced_sub_archetypes = {"WET"}, 
                        description_generator = function(ctx)
                            return " Its lineage was born from " .. ctx.race .. " " .. ctx.name .. " of " .. ctx.civ .. " in " .. ctx.year .. " from the defeated populace of their enemy."
                        end
                    },
                    {
                        config = config_nanomachine, 
