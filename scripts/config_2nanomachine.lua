return {
    ...
    {
        body_token = "",
        desc_part = "A postbiological organism made of nanomachine colonies united in imitation of biological cell structures. This variant descends from some of the most radical posthuman sects, seeking new power through unconventional paths of evolution. Its body is a silvery, reflective surface, moving like a living thing and perfectly still when at rest. ",
		...
		size_specific_tokens = {
             ...
             ["HUGE"] = "[CASTE_TILE:'P'] ",
             ["GIANT"] = "[CASTE_TILE:'P'] ",
             ["TITANIC"] = " [CASTE_TILE:'P'] "
        },
        weight = 50,
		next_tables = {
		"procgen_subchart_table_pure_body"
		}
    },
    {
        body_token = "",
        desc_part = "A postbiological organism made of nanomachine colonies united in imitation of biological cell structures. This variant descends from the irregular mutations of nanite colonies within the megastructures when they interface with living beings, forming monstrous, cancerous hybrids. Its slightly metallic, skin-like exterior seems almost decayed, ragged openings showing slick black nanomechanical muscle within while veins snake through what places its integument is solid. ",
		eligible_rating_tags = {"SOPHONT", "DEVIANT", "AVATAR", "VESSEL", "HOSTILE", "INCURSION", "EXISTENTIAL", "DANGEROUS", "BENIGN", "HAZARDOUS", "PROBLEMATIC", "DOMESTIC", "COMPANION", "NOMAD", "VEHICLE", "CARRIER", "HUNTER", "WEAPON", "MILITARY", "SERVANT", "SANITATION", "PRODUCT", "VERMIN", "AMBIENT"},
    ...
    },
    {
        ...
        desc_part = "A postbiological organism made of nanomachine colonies united in imitation of biological cell structures. This variant is a product of the Fade, when even postbiological life struggled to adapt to the rapid decline of the megastructure's energy levels. Its exterior is slick and black, like mold. ",
		eligible_rating_tags = {"SOPHONT", "DEVIANT", "AVATAR", "VESSEL", "HOSTILE", "INCURSION", "EXISTENTIAL", "DANGEROUS", "BENIGN", "HAZARDOUS", "PROBLEMATIC", "DOMESTIC", "COMPANION", "NOMAD", "VEHICLE", "CARRIER", "HUNTER", "WEAPON", "MILITARY", "SERVANT", "SANITATION", "PRODUCT", "VERMIN", "AMBIENT"},
        eligible_size_tags = {"LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT", "TITANIC"}, 
		sub_archetype = {"WET"},
        tok = {
