...
return {
    ...
    generic_creature_lore_snippets = {
        "_______________________________________________________ _____/HISTORY = The hi-caste are the descendants of homeworld humans who served the Geno-Autarchs, bred not to colonize the harsh frontiers of the system with minimal aid but to excel at a specific vocation underneath the imperial clade. Though their masters have been dead for uncountable centuries the stability of the hi-caste genome ensures their lineages survive into the distant future, even if they have grown into forms and roles their makers could never have anticipated. _______________________________________________________ _____",
    },
    ...
    procgen_addon_table_1 = {
        {
            ...
            desc_part = "_______________________________________________________ _____/TYPE = A human with a complex barcode on its forehead marking it as one of the Civclade, a gene-tailored human built for managerial and social labor. _______________________________________________________ _____/DESC = ",
        ...
        {
            body_token = "HUMANOID_NECK:2EYES:2EARS:NOSE:2LUNGS:HEART:GUTS:ORGANS:HUMANOID_JOINTS:THROAT:NECK:SPINE:BRAIN:SKULL:5FINGERS:5TOES:MOUTH:TONGUE:FACIAL_FEATURES:TEETH:RIBCAGE",
            desc_part = "_______________________________________________________ _____/TYPE = A human with a complex barcode on its forehead marking it as one of the Warclade, a gene-tailored human built for combat, terror, and law enforcement. _______________________________________________________ _____/DESC = ",
            eligible_rating_tags = {"SOPHONT"},
        ...
        {
            body_token = "HUMANOID_NECK:2EYES:2EARS:NOSE:2LUNGS:HEART:GUTS:ORGANS:HUMANOID_JOINTS:THROAT:NECK:SPINE:BRAIN:SKULL:5FINGERS:5TOES:MOUTH:TONGUE:FACIAL_FEATURES:TEETH:RIBCAGE",
            desc_part = "_______________________________________________________ _____/TYPE = A human with a complex barcode on its forehead marking it as one of the Joyclade, a gene-tailored human built for entertainment and aesthetics. _______________________________________________________ _____/DESC = ",
            eligible_rating_tags = {"SOPHONT"},
            eligible_size_tags = {"MEDIUM"}, 
