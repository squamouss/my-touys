    ...
    procgen_addon_table_1 = {
        {
            ...
            desc_part = "A human with a complex barcode on its forehead marking it as one of the Civclade, a gene-tailored human built for managerial and social labor. ________________________________________________________________________________/",
        ...
        {
            body_token = "HUMANOID_NECK:2EYES:2EARS:NOSE:2LUNGS:HEART:GUTS:ORGANS:HUMANOID_JOINTS:THROAT:NECK:SPINE:BRAIN:SKULL:5FINGERS:5TOES:MOUTH:TONGUE:FACIAL_FEATURES:TEETH:RIBCAGE",
            desc_part = "A human with a complex barcode on its forehead marking it as one of the Warclade, a gene-tailored human built for combat, terror, and law enforcement. ________________________________________________________________________________/",
            eligible_rating_tags = {"SOPHONT"},
        ...
        {
            body_token = "HUMANOID_NECK:2EYES:2EARS:NOSE:2LUNGS:HEART:GUTS:ORGANS:HUMANOID_JOINTS:THROAT:NECK:SPINE:BRAIN:SKULL:5FINGERS:5TOES:MOUTH:TONGUE:FACIAL_FEATURES:TEETH:RIBCAGE",
            desc_part = "A human with a complex barcode on its forehead marking it as one of the Sciclade, a gene-tailored human built for engineering and digital infrastructure management. ________________________________________________________________________________/",
            eligible_rating_tags = {"SOPHONT"},
            eligible_size_tags = {"MEDIUM"}, 
        ...
        {
            body_token = "HUMANOID_NECK:2EYES:2EARS:NOSE:2LUNGS:HEART:GUTS:ORGANS:HUMANOID_JOINTS:THROAT:NECK:SPINE:BRAIN:SKULL:5FINGERS:5TOES:MOUTH:TONGUE:FACIAL_FEATURES:TEETH:RIBCAGE",
            desc_part = "A human with a complex barcode on its forehead marking it as one of the Joyclade, a gene-tailored human built for entertainment and aesthetics. ________________________________________________________________________________/",
            eligible_rating_tags = {"SOPHONT"},
            eligible_size_tags = {"MEDIUM"}, 
