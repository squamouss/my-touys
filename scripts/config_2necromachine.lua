return {
    ...
    generic_creature_lore_snippets = {
        "Necromachines are a product of the Transitional Era, a time when unfathomable armies led by superhuman intelligences waged long, slow wars of grinding attrition. They are capable of surviving off of scrap and flesh alike, and can repair themselves simply by consuming enough biomass. But of all the posthuman templates, they are individually the weakest, relying on numbers, cunning and preying on those weaker still to survive an immeasurably hostile solar system. ",
    },
    ...
    interaction_rating = {
        ...
        },
        {
            ...
            tok = {[[
			            [COLOR:4:0:0][NIGHT_CREATURE_EXPERIMENTER]
            [ATTACK_TRIGGER:3:3:3]
            [BUILDINGDESTROYER:2]
    ...
    {
        body_token = "",
        desc_part = "A hybrid organism using both machinery and cloned tissue in a grotesque fusion. This variant descends from the mechanized corpse-hordes of the Transitional Era arcology-factories, muscle and sinew wrapped around a utilitarian mechanical endoskeleton more akin to a machine's innards than an approximation of biological scaffolding. It still and precise movements",
    ...
    {
        body_token = "",
        desc_part = "A hybrid organism using both machinery and cloned tissue in a grotesque fusion. This variant descends from the feral necromachine hives and strays which arose from the detritus of the Myriad Era, forming a family of mechlife adapted to the technosystem",
		eligible_rating_tags = {"SOPHONT", "DEVIANT", "AVATAR", "VESSEL", "HOSTILE", "INCURSION", "EXISTENTIAL", "DANGEROUS", "BENIGN", "HAZARDOUS", "PROBLEMATIC", "DOMESTIC", "COMPANION", "NOMAD", "VEHICLE", "CARRIER", "HUNTER", "WEAPON", "MILITARY", "SERVANT", "SANITATION", "PRODUCT", "VERMIN", "AMBIENT"},
        ...
        weight = 20,
		next_tables = {
		"procgen_subchart_table_swarm_body"
		}
    },
    {
        body_token = "",
        desc_part = "A hybrid organism using both machinery and cloned tissue in a grotesque fusion. This variant originates from the Fade, where both human castes and less fortunate necromachines of other templates evolved down the path of the scavenger and survivalist. Its body is skeletal with an organic-seeming metallic endoskeleton.",
			eligible_rating_tags = {"SOPHONT", "VESSEL", "HOSTILE", "DANGEROUS", "BENIGN", "HAZARDOUS", "PROBLEMATIC", "DOMESTIC", "NOMAD", "HUNTER", "WEAPON", "MILITARY", "SERVANT", "SANITATION", "PRODUCT", "VERMIN", "AMBIENT"},
        eligible_size_tags = {"LESSER", "MEDIUM", "LARGE", "HUGE", "GIANT", "TITANIC"}, 
