...
return {
   ...
   interaction_rating = {
    ...
    {
        body_token = "",
        desc_part = "A human of the Transitional Era, the product of hereditary cyberization through N-matter in defiance of the genetic caste system. It is little more than a sack of organs encased in a fully mechanical body, the pinnacle of human augmentation before abandoning comprehensible science. This variant emerged during the days of the Geno-Autarchies and rose to rule their own domains when biological science was left behind. In the present they still hold a place of prominence, but their position at the pinnacle has been eclipsed by far greater posthuman entities. ________________________________________________________________________________/",
        eligible_rating_tags = {"SOPHONT", "DEVIANT", "AVATAR", "HOSTILE"},
		...
		size_specific_tokens = {
             ["LESSER"] = "[CASTE_TILE:'y'][CASTE_SOLDIER_TILE:152] ",
             ["MEDIUM"] = "[CASTE_TILE:'y'][CASTE_SOLDIER_TILE:152] ",
             ["LARGE"] = "[CASTE_TILE:'Y'] ",
             ["HUGE"] = "[CASTE_TILE:'Y']  ",
             ["GIANT"] = "[CASTE_TILE:'Y']  ",
             ["TITANIC"] = " [CASTE_TILE:'Y']  "
        },
		next_tables = {
		"procgen_subchart_table_fullbody_body"
		}
    }
    },
	...
	-- 
		...
		"procgen_subchart_table_cyborg_legs"
            ...
            {     
                body_token = "", 
                desc_part = "It has a weak, emaciated body assisted by a mechanical endoskeleton half-embedded into its body, raw and scarred where its metal struts and joints embed in flesh and bone, and ",
				eligible_rating_tags = {"SOPHONT", "HOSTILE"},
		...
		"procgen_subchart_table_cyborg_legs"
            ...
            {     
                body_token = "", 
                desc_part = "It has a sickly, discolored body, with a life-support system of pulsing tubes and bulbous mechanical protrusions half-embedded into its body, raw and scarred where they burrow into flesh and bone, and ",
				eligible_rating_tags = {"SOPHONT", "HOSTILE"},
				eligible_size_tags = {"LARGE", "HUGE"}, 
                tok = {[[
	...
	-- =================================================================================================================================================================================================
		...
		next_tables = { 
		"procgen_subchart_table_dermal",
		"procgen_subchart_table_fullbody_head",
		"procgen_subchart_table_fullbody_arms",
		"procgen_subchart_table_fullbody_legs"
		}
    },
    {
