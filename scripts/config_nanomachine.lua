return {
    ...
    generic_creature_lore_snippets = {
        "Nanomechanical N-life is one of the last forms of life to emerge within the technosystem, existing almost wholly beyond the comprehension of human science. Most are chaotic, decrepit entities, half-formed by complex processes which lack the proper environment to foster such novel phyla, leaving them erratic and ravenous. But the sheer mutability of their forms grant a blessing to physical transmutation systems." ,
    },
    ...
    {
        body_token = "",
        desc_part = "A postbiological life form comprised of nanomachine colonies united in the manner of multicellular organisms. It has tarry, glistening flesh covered by a shimmering, reflective integument. This variant emerged from esoteric experiments on N-matter, giving rise to some of the technosystem's strangest forms of life. ",
