return {
    ...
    generic_creature_lore_snippets = {
        "Nanomechs are one of the last forms of life to emerge within the technosystem, existing almost wholly beyond the comprehension of human science. Most are chaotic, decrepit entities, half-formed by complex processes which lack the proper environment to foster such novel phyla, leaving them erratic and ravenous. But when nurtured carefully, they can bloomn into some of the most wondrous and alien beings of the long night." ,
    },
    ...
    {
        body_token = "",
        desc_part = "A postbiological life form comprised of nanomachine colonies united in the manner of multicellular organisms. It has tarry, glistening flesh covered by a shimmering, reflective integument. This variant emerged from esoteric expriments on N-matter, giving rise to some of the technosystem's strangest forms of life. ",
	...
	[ATTACK:BITE:CHILD_BODYPART_GROUP:BY_CATEGORY:BODY:BY_CATEGORY:TOOTH]
        ...
        procgen_subchart_table_corrupt_head = {
            {    
                body_token = ":HEADNECK_MODULAR:2EYES:2EARS:NOSE:MOUTH:TONGUE:FACIAL_FEATURES:TEETH", 
		...
		"procgen_subchart_table_corrupt_hair"
            ...
            {     
                body_token = ":HEADNECK_MODULAR:2EARHOLE:2NOSEHOLE:MOUTH:TONGUE:TEETH", 
	...
	-- =================================================================================================================================================================================================
		...
		"procgen_subchart_table_wet_legs"
            ...
            {     
				...
				eligible_rating_tags = { "HOSTILE", "DANGEROUS", "BENIGN", "PROBLEMATIC", "DOMESTIC", "WEAPON", "SERVANT" },
				eligible_size_tags = {"LESSER", "MEDIUM", "LARGE", "HUGE"}, 
                tok = {[[
