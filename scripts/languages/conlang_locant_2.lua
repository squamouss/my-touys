...
languages.GEN_LOCANT_2 = function()


    local words_end_in_vowel_chance = 80


    local common_vowel = { "a", "i", "u", "e", "o" }
    local medium_vowel = {}
    local rare_vowel = {}

    local common_vowel_pair = { "ai", "ao", "ou" }
    local medium_vowel_pair = { "ua", "uo", "ie", "ei" }
    ...
    local common_consonant = { "k", "s", "t", "n", "h", "m", "y", "r", "w", "g", "d", "b", "p", "ch", "sh" }
    local medium_consonant = { "j", "z" }
    ...
    local common_middle_only = { "kk", "tt", "ss", "pp" }
    local medium_middle_only = { "nn", "mm" }
    local rare_middle_only = {}

    local common_end_only_consonant = {"n"}
    local medium_end_only_consonant = {"ng", "m"}
