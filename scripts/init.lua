...
-- Allows languages to be registered before civs are generated
...
table.insert(do_once_early, function()
    ...
    -- [[ MOVED FROM DO_ONCE: EARLY ATTRIBUTE & WEAPON GENERATION ]] --
    ...
    -- 1. Generate Ancient/Posthuman Languages
    generate_early_languages_hook()

    -- 2. Generate Early Config Creatures
