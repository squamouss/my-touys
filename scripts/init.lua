...
local modules_to_bust = {
    ...
    "weaponizer_engine",  
    "config_weapons",
    "transmutation.config_attributes_master",
    "transmutation.generator_attribute",
    "transmutation.config_digital_warfare", -- Added Digital Warfare Config
    "transmutation.generator_digital_warfare" -- Added Digital Warfare Generator
}
...
table.insert(do_once_early, function()
    ...
    -- [[ MEGASTRUCTURE GENERATOR EXECUTION ]] --
    ...
    if digi_warfare_generator and digi_warfare_config then
        pcall(digi_warfare_generator.generate_digital_warfare_systems, digi_warfare_config)
